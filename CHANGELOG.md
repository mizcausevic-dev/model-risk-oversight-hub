...
### Released
- Shipped **model-risk-oversight-hub** as a public artifact for teams dealing with platform governance.
...
### Shipped
- Cut the first coherent internal version of **model-risk-oversight-hub** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: React + TypeScript oversight hub for model criticality, release gating, evaluation drift, and executive AI risk visibility
- Focused the repo around actionability instead of passive reporting.

## [Prototype] - 2025-05-11
