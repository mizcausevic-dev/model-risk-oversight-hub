...
### Released
- Published **model-risk-oversight-hub** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **model-risk-oversight-hub**.
...
- That insight became the basis for **model-risk-oversight-hub**.
